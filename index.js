...
var orientationWillChangeEvent = 'orientationWillChange';
...
module.exports = {
  ...
  addOrientationWillChangeListener(cb) {
    var key = getKey(cb);
    listeners[key] = DeviceEventEmitter.addListener(orientationWillChangeEvent,
      (body) => {
        cb(body.orientation);
      });
  },
  ...
  removeOrientationWillChangeListener(cb) {
    var key = getKey(cb);
